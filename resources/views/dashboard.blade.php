...
@section('content')
    ...
    <div  class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg"> <a href="/barang"> <i class="icon-briefcase"></i> Barang </a> </li>
        <li class="bg_ly"> <a href="/supplier"> <i class="icon-copy"></i> Kartu Stok </a> </li>
        <li class="bg_lo"> <a href="/customer"> <i class="icon-group"></i> Customer </a> </li>
        <li class="bg_lb"> <a href="/supplier"> <i class="icon-tasks"></i> Supplier </a> </li>
        <li class="bg_lg"> <a href="/pembelian"> <i class="icon-th-large"></i> Pembelian</a> </li>
        <li class="bg_ls"> <a href="/pembelian"> <i class="icon-th"></i> Detail Pembelian</a> </li>
        <li class="bg_ly"> <a href="/supplier"> <i class="icon-external-link"></i> Penjualan </a> </li>
        <li class="bg_lo"> <a href="/customer"> <i class="icon-qrcode"></i> Detail Penjualan </a> </li>
